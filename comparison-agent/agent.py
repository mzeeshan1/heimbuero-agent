            ...
            json={
                ...
                "messages": [{
                    ...
                    "content": (
                        ...
                        f"- Intro: eine selbstironische Beobachtung zum Kaufdilemma, "
                        f"  z.B. '400 Modelle auf Amazon, alle angeblich die besten.'\n"
                        f"- Mitte: eine kurze Analogie die einen Nachteil verdeutlicht, "
                        f"  z.B. 'Klingt gut im Prospekt — wie das Laufband im Keller.'\n"
                        f"- Fazit: ein trockenes Understatement, "
